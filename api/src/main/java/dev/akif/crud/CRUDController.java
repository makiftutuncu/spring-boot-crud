 ...
 * @param <DTOMapper> DTO mapper type of the data
...
public abstract class CRUDController<
        ...
        DTOMapper extends CRUDDTOMapper<I, E, M, D, CM, UM, CD, UD>,
    ...
    /**
     * DTO mapper dependency of this controller
     */
     ...
     * @param mapper  DTO mapper dependency of this controller
     */
    protected CRUDController(final String type, final S service, final DTOMapper mapper) {
        this.type = type;
    ...
    public Paged<D> getAll(
        ...
        final var pagedDTOs = new Paged<>(pagedModels).map(mapper::modelToDTO);
    ...
    public D update(
        ...
        final var updateModel = mapper.updateDTOToUpdateModel(updateDTO);
