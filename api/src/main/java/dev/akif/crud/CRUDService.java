...
public abstract class CRUDService<
     ...
     */
    protected final CRUDRepository<I, E> repository;
    /**
     * Mapper dependency of this controller
     */
     ...
     */
    protected CRUDService(final String type, final Clock clock, final CRUDRepository<I, E> repository, final Mapper mapper) {
        this.type = type;
        this.clock = clock;
    ...
    public M create(final CM createModel) {
        ...
        final var entity = mapper.entityToBeCreatedFrom(createModel, Instant.now(clock));
        ...
        final var model = mapper.entityToModel(saved);
    ...
    public Page<M> getAll(final Pageable pageable) {
        ...
        final var models = entities.map(mapper::entityToModel);
    ...
    public Optional<M> get(final I id) {
        ...
        return entity.map(e -> {
            final var m = mapper.entityToModel(e);
    ...
    public M update(final I id, final UM updateModel) {
        ...
        final var updated = mapper.updateEntityWith(updateModel, entity).updatedNow(Instant.now(clock));
        ...
        final var model = mapper.entityToModel(updated);
     ...
     * @param <Data> Type of the data describing the entity
     * @return Result of the persisting action
     */
    @Transactional
    protected <A, Data> A persist(final Supplier<A> action, final Data data) {
        try {
